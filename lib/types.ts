...
export interface CoreCoverPageData {
  ...
  /** "Normal" uses BOQ_Details subform; "Tender" uses BOQ subform */
  Type_field?: string
  /** Parsed filepath for Excel_Upload1 attachment (Tender BOQ PDF) */
  Excel_Upload1_filepath?: string | null
  BOQ?: DoorCoreBOQItem[]
...
/** Quotation_Log_Fitout_2: subform row (Manually_Filled) */
export interface QuotationLogFitout2ManualItem {
  Item?: string
  Description?: string
...
export interface QuotationLogFitout2Data {
  ...
  Sub_Total3?: string | number
  Manually_Filled?: QuotationLogFitout2ManualItem[]
